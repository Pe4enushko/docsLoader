...
CHECKPOINT_FILE = ".graphrag_ingest_checkpoint_postgres.json"
LOG_FILE = "logs/init_knowledge_graph_postgres.log"
...
def main() -> None:
    ...
    try:
        ...
        log.exception("Knowledge graph initialization (postgres) failed")
        raise
    finally:
        adapter.close()
